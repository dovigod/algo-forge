...
var client_1 = require("@const/client");
var server_1 = require("@const/server");
var resolve_path_1 = require("@server/utils/resolve-path");
            ...
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, vite_1.createServer)({
                            publicDir: (0, resolve_path_1.resolveClientPath)(server_1.PATH_TO_STATIC_SERVE),
                            server: {
                                // @ts-ignore - wtf?
                                middlewareMode: 'ssr',
                            },
                            appType: 'custom',
                            base: client_1.CLIENT_BASE,
                        })];
                case 1:
